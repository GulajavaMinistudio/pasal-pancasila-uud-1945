...
**PRD Features yang dicakup:** F-04, F-05, F-06, F-07, F-08, F-10, F-11, F-12
...
| TASK-011 | Buat `src/pages/AmandemenPage.js` — daftar pasal yang mengalami amandemen dari `loadPasalUUDKetAmandemen()`. Tampilkan badge amandemen (I, II, III, IV) sesuai field `amandemen` di data | | |
| TASK-012 | Implementasi group-by amandemen di `AmandemenPage`: section terpisah per Amandemen I, II, III, IV dengan pasal-pasalnya | | |
...
- **FILE-017**: `src/router/routes.js` — tambah 9 route baru + catch-all 404
...
- [PRD: Pancasila & UUD 1945 Web App](../prd_pasaluud1945_webapp.md) — F-04, F-05, F-06, F-07, F-08, F-10, F-11, F-12
- [Spesifikasi Arsitektur](../spec/spec-architecture-pasaluud1945-webapp.md) — §4.2 Routing, §5.2 Pencarian, §9.1 Contoh SearchPasal
- [Spesifikasi Data Schema](../spec/spec-data-schema-pasaluud1945.md) — Schema pasaluud45.json, babpasal.json, ket_amandemen.json
